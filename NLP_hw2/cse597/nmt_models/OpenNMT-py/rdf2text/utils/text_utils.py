...
def initialize_tagger(DIR):
    ...
    NERTagger = StanfordNERTagger(
        DIR + 'classifiers/english.muc.7class.distsim.crf.ser.gz',
        DIR + 'stanford-ner.jar',
        encoding='utf-8')
...
def extract_named_entities(text):
    ...
    NERTagger = initialize_tagger('/home/karen/Downloads/stanford-ner-2018-10-16/')
    ...
    print('name entities: ', named_entities)
...
def test_NER():
    ...
    text = 'The alternative name for Ajoblanco is "Ajo blanco".'
