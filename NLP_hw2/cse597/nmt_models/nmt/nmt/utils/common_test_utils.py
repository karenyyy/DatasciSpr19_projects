...
def create_test_hparams(unit_type="lstm",
  ...
  # Infer
  standard_hparams.tgt_max_len_infer = 600
  ...
  standard_hparams.src_embed_file = '/home/karen/workspace/nmt/GloVe/vectors.txt'
  standard_hparams.tgt_embed_file = '/home/karen/workspace/nmt/GloVe/vectors.txt'

  # For inference.py test
  standard_hparams.subword_option = "bpe"
  standard_hparams.src = "src"
  standard_hparams.tgt = "tgt"
  standard_hparams.src_max_len = 600
